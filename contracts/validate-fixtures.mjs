...
const fixtureToSchema = {
  ...
  'channel-goal-trigger-rule-response.json': 'channel-goal-trigger-rule-response.schema.json',
  'channel-goal-trigger-rule-list-response.json': 'channel-goal-trigger-rule-list-response.schema.json',
  'channel-goal-trigger-condition-response.json': 'channel-goal-trigger-condition-response.schema.json',
  'channel-goal-trigger-condition-list-response.json': 'channel-goal-trigger-condition-list-response.schema.json',
  'channel-goal-trigger-action-response.json': 'channel-goal-trigger-action-response.schema.json',
  'channel-goal-trigger-action-list-response.json': 'channel-goal-trigger-action-list-response.schema.json',
  'channel-goal-trigger-action-run-list-response.json': 'channel-goal-trigger-action-run-list-response.schema.json',

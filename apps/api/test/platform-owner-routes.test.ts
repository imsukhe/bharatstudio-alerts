...
function buildApp(testConfig: RuntimeConfig, dependencies: AppDependencies) { return rawBuildApp(testConfig, { ...dependencies, adminPasskeys: mfa, adminWebAuthn: { rpId: 'admin.test', origins: ['http://localhost:3105'], challengeTtlSeconds: 60, mfaMaxAgeSeconds: 60 } }); }

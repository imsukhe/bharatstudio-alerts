...
export interface ChannelStore {
  ...
  updateChannel(userId: string, channelId: string, input: { displayName?: string; acceptingTips?: boolean; featuredConsent?: boolean; handle?: string }): Promise<ChannelDetails | null>;
